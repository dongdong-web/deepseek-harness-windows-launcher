...
foreach ($requiredPath in @(
    ...
    (Join-Path $runtimeRoot 'app/node_modules/@dsh-community/dsh-client-ui-drive-picker/client.js'),
    (Join-Path $runtimeRoot 'app/node_modules/@dsh-community/dsh-client-ui-drive-picker/package.json'),
    (Join-Path $runtimeRoot 'app/node_modules/dsh-file-explorer/lib/client.js'),
    (Join-Path $runtimeRoot 'app/node_modules/dsh-file-explorer/lib/index.js'),
    (Join-Path $runtimeRoot 'app/node_modules/dsh-file-explorer/package.json'),
    (Join-Path $runtimeRoot 'app/node_modules/dsh-chat-outline/lib/client.js'),
    (Join-Path $runtimeRoot 'app/node_modules/dsh-chat-outline/package.json'),
    (Join-Path $runtimeRoot 'app/node_modules/@steven-wu/dsh-cost-meter/lib/client.js'),
    (Join-Path $runtimeRoot 'app/node_modules/@steven-wu/dsh-cost-meter/lib/index.js'),
    (Join-Path $runtimeRoot 'app/node_modules/@steven-wu/dsh-cost-meter/package.json'),
    (Join-Path $runtimeRoot 'app/node_modules/dsh-balance-tide/client/client.js'),
    (Join-Path $runtimeRoot 'app/node_modules/dsh-balance-tide/src/index.js'),
    (Join-Path $runtimeRoot 'app/node_modules/dsh-balance-tide/package.json'),
    (Join-Path $runtimeRoot 'app/node_modules/@huanlin/dsh-plugin-session-delete/src/client.js'),
    (Join-Path $runtimeRoot 'app/node_modules/@huanlin/dsh-plugin-session-delete/src/index.js'),
    (Join-Path $runtimeRoot 'app/node_modules/@huanlin/dsh-plugin-session-delete/package.json'),
    (Join-Path $runtimeRoot 'app/node_modules/dsh-ding/lib/client.js'),
    (Join-Path $runtimeRoot 'app/node_modules/dsh-ding/lib/index.js'),
    (Join-Path $runtimeRoot 'app/node_modules/dsh-ding/notify.ps1'),
    (Join-Path $runtimeRoot 'app/node_modules/dsh-ding/package.json'),
    (Join-Path $runtimeRoot 'app/node_modules/dsh-lan-pass/lib/index.js'),
    (Join-Path $runtimeRoot 'app/node_modules/dsh-lan-pass/package.json'),
...
foreach ($expectedEntry in @(
    ...
    'app/node_modules/dsh-file-explorer/lib/client.js',
    'app/node_modules/dsh-file-explorer/lib/index.js',
    'app/node_modules/dsh-file-explorer/package.json',
    'app/node_modules/dsh-chat-outline/lib/client.js',
    'app/node_modules/dsh-chat-outline/package.json',
    'app/node_modules/@steven-wu/dsh-cost-meter/lib/client.js',
    'app/node_modules/@steven-wu/dsh-cost-meter/lib/index.js',
    'app/node_modules/@steven-wu/dsh-cost-meter/package.json',
    'app/node_modules/dsh-balance-tide/client/client.js',
    'app/node_modules/dsh-balance-tide/src/index.js',
    'app/node_modules/dsh-balance-tide/package.json',
    'app/node_modules/@huanlin/dsh-plugin-session-delete/src/client.js',
    'app/node_modules/@huanlin/dsh-plugin-session-delete/src/index.js',
    'app/node_modules/@huanlin/dsh-plugin-session-delete/package.json',
    'app/node_modules/dsh-ding/lib/client.js',
    'app/node_modules/dsh-ding/lib/index.js',
    'app/node_modules/dsh-ding/notify.ps1',
    'app/node_modules/dsh-ding/package.json',
    'app/node_modules/dsh-lan-pass/lib/index.js',
    'app/node_modules/dsh-lan-pass/package.json',
    'launcher/start.vbs',
    'launcher/start.cmd',
