...
foreach ($requiredPath in @(
    ...
    (Join-Path $runtimeRoot 'app/node_modules/dsh-balance-meter/lib/client.js'),
    (Join-Path $runtimeRoot 'app/node_modules/dsh-balance-meter/lib/index.js'),
    (Join-Path $runtimeRoot 'app/node_modules/dsh-balance-meter/package.json'),
...
foreach ($expectedEntry in @(
    ...
    'app/node_modules/dsh-balance-meter/lib/client.js',
    'app/node_modules/dsh-balance-meter/lib/index.js',
    'app/node_modules/dsh-balance-meter/package.json',
    'launcher/start.vbs',
    'launcher/start.cmd',
